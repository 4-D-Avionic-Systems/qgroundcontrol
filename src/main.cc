...
//----------------------4DAS Changes----------------------
    system("dotnet build ~/git_repos/CSharp_ConflictDetection_Resolution_MVP/CDR_MVP/ && ASPNETCORE_URLS=http://localhost:5248 dotnet exec ~/git_repos/CSharp_ConflictDetection_Resolution_MVP/CDR_MVP/CDR_MVP/bin/Debug/net8.0/CDR_MVP.dll &");
//--------------------------------------------------------
